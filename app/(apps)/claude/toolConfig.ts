...
export const toolConfig: ToolConfig = {
  ...
  company: {
    ...
    appUrl: "/apps/claude",
    description:
      "Build your own Claude 4 Sonnet AI wrapper in minutes with this demo app that uses Anthropic, LangChain & Supabase.",
  ...
  ////// SEO stuff
  metadata: {
    title: "Claude 4 Sonnet AI Wrapper | AnotherWrapper",
    description:
      "Build your own Claude 4 Sonnet AI wrapper in minutes with this demo app that uses Anthropic, LangChain & Supabase.",
