...
import { Chat as PreviewChat, type ExtendedMessageMetadata } from "../components/chat";
import {
  getChatById,
  getMessagesByChatId,
  getSession,
...
export default async function Page(props: { params: Promise<any> }) {
  ...
  return (
    <PreviewChat
      id={chat.id}
      initialMessages={convertToUIMessages<ExtendedMessageMetadata>(messagesFromDb)}
